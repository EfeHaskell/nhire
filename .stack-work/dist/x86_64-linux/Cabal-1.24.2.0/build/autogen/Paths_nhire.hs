...
sysconfdir = "/home/eariaroo/Documents/projects/haskell/nhire/.stack-work/install/x86_64-linux/lts-8.16/8.0.2/etc"

getBinDir, getLibDir, getDynLibDir, getDataDir, getLibexecDir, getSysconfDir :: IO FilePath
getBinDir = catchIO (getEnv "nhire_bindir") (\_ -> return bindir)
getLibDir = catchIO (getEnv "nhire_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "nhire_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "nhire_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "nhire_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "nhire_sysconfdir") (\_ -> return sysconfdir)
